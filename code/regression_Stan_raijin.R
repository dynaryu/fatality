...
genMCMC <- function(adaptSteps = 5000, burnInSteps = 10000, nChains = 4, thinSteps = 1, 
                    numSavedSteps = 30000, modelObject = stanDso, dataList = dataList, saveName = saveName, saveType = 'png') {
...
csvfileName_wald = '~/scratch/fatality/DATA_WALD_COR_ROUND_12_Feb_2013.csv'
develop_model_using_data(csvfileName_wald,'regression_wald_23Feb','eps')
